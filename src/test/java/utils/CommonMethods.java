...
public class CommonMethods extends PageInitializer {
  ...
  //method will wait for the element to be clickable
    ...
    //method will return JavaScriptExecutor Object
    public static JavascriptExecutor getJSExecutor(){
        JavascriptExecutor js=(JavascriptExecutor) driver;
        return js;
    }

    //method will perform click on element using javascript executor
    public static void jsClick(WebElement element){
        getJSExecutor().executeScript("arguments[0].click();",element);
    }

    //selecting the dropdown using text
    public static void selectDropdawn(WebElement element, String text){
